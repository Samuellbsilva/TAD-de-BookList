...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Digite a capacidade máxima da sua lista de livros: ");
        ...
        do {
            ...
            System.out.println("\n- MENU LISTA DE LIVROS -");
            System.out.println("1. Adicionar livros ID");
            System.out.println("2. Remover livros por ID");
            System.out.println("3. Remover por Posição");
            System.out.println("4. Buscar livros ID");
            System.out.println("5. Atualizar ID de livros");
            System.out.println("6. Ver Total de livros e Status");
            ...
            switch (opcao) {
                case 1:
                    if (minhaEbook.estaCheia()) {
                        System.out.println("Erro: A lista de livros está lotada!");
                    } else {
                ...
                case 7:
                    ...
                    System.out.println("list a de livros zerada.");
                    break;
